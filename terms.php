<script type="text/javascript">
	function safePop(URL,width,height) {width = width || '475';height = height || '500';day = new Date();id = day.getTime();eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width="+width+", height="+height+",left = 0,top = 0');");}
</script>
<style type="text/css">
#content{margin:30px;}
p{font-family:"Book Antiqua", "Palatino Linotype", Palatino, serif; font-size:14px; line-height:20px; margin:0 0 20px;}
h1{font-size:14px; font-weight:bold; text-align:center;}
h2{font-size:14px; font-weight:bold; margin:25px 0 0;}
h3{font-size:14px; font-style:italic; margin:25px 0 0;}
h4{font-size:14px; text-decoration:underline; margin:25px 0 0;}
ul{list-style:disc;}
ul li{font-family:"Book Antiqua", "Palatino Linotype", Palatino, serif; font-size:14px; line-height:20px; margin:0 0 10px 5px;}
</style>
<div id="content">
<p><b>Last Updated and Effective: <?php echo date("F d, Y");?></b></p>

<h1>Terms of Use</h1>

<p style="font-style:italic">Please read these website Terms of Use ("Terms") carefully before using this website, including any of the discussion forums available on this website (each a "Forum") (collectively, this website and the Forums are referred to hereafter as the "Site").</p>

<p style="font-style:italic">Using this Site indicates that you accept these Terms. If you do not accept these Terms, do not use this Site or Company's (as hereinafter defined) products and services.</p>

<h2>Introduction</h2>

<p>This Site is owned and operated by Procommercellc, LLC ("Company", "we", "our" or "us"). Company reserves the right to revise or remove any part of the Terms in its sole discretion at any time and without prior notice to you by updating this posting of the Terms. You thus should visit this page periodically for changes.  This Site is continually under development and changes to this Site may be made at any time.  Any changes to the Terms are effective upon posting to this Site.  If you disagree with the Terms, your sole remedy is to discontinue your use of this Site. Your continued use after a change has been posted by Company constitutes your acceptance of such change.  As such these Terms shall be considered legally binding and shall govern your use of the Site, as well as your purchase of any Company products.</p>
...
<p><a href="mailto:support@l-citrullinereviews.org">support@l-citrullinereviews.org</a><br>
801-310-0986<br>
4778 North 300 West<br>
Suite 120<br>
Provo, UT 84604</p>

<p>If your questions or concerns relate to products or services offered on the Site, please access our Customer Service page at <a target="_blank" href="http://www.l-citrullinereviews.org/contact.php">http://www.l-citrullinereviews.org/contact.php</a></p>
...
<h4>Information in Submitted Messages</h4>
...
<p>You may delete any of your messages posted to a Forum at any time by sending an email to <a href="mailto:support@l-citrullinereviews.org">support@l-citrullinereviews.org</a>, and requesting that the particular message be deleted.</p>

<h4>Moderated Forums</h4>

<p>The Forums may be moderated by employees of Company (each a "Moderator"). The Moderators may review your submitted messages, including any attached materials such as linked websites and pictures, and may edit or reject the messages at their discretion for any or no reason. Submitted messages that may be edited or rejected by the Moderators include, but are not limited to, messages that are deemed to be offensive, infringe on copyright rights of others, impersonate an individual, misrepresent a relationship with any person or organization, encourage others to commit illegal acts or to harass individuals, or advertise or promote goods and services. To have messages posted, the comments must be on topic.</p>

<p>Messages considered offensive by any registered user of the Forums may be reported to the Moderators by sending an email to <a href="mailto:support@l-citrullinereviews.org">support@l-citrullinereviews.org</a>. 
...
<p>This Site is governed by the terms set forth in Privacy Policy <a href="javascript:safePop('http://www.l-citrullinereviews.org/privacy.php')">http://www.l-citrullinereviews.org/privacy.php</a>. Please carefully review the Privacy Policy before using the Site. If you are unwilling to accept the Privacy Policy, please discontinue your use of the Site.</p>
...
<p>Procommercellc, LLC<br>
4778 North 300 West<br>
Suite 120<br>
Provo, UT 84604</br>
801-310-0986<br>
<a href="mailto:support@l-citrullinereviews.org">support@l-citrullinereviews.org</a></p>
...
<p>Please see the Customer Service page <a target="_blank" href="http://www.l-citrullinereviews.org/contact.php">http://www.l-citrullinereviews.org/contact.php</a> for more information regarding returns, refunds, guarantees, and warranties.</p>
