	...
	<div class="row">
		<div class="small-24 medium-24 columns end">
			...
			<li>&copy; 2013-<?php echo date('Y');?>, <?php echo get_bloginfo('name'); ?></li>
			 <li><a href="javascript:safePop('<?php echo site_url(); ?>/privacy.php')">Privacy Policy</a></li>
			 <li><a href="javascript:safePop('<?php echo site_url(); ?>/terms.php')">Terms and Conditions</a></li>
		</div> <!-- / .small-12 -->
	</div> <!-- / .row -->
